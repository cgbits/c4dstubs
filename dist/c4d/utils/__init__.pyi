...
class GeRayCollider(object):
    ...
    def Init(self, goal: PolygonObject, force: bool) -> bool:
        ...
        ...
    def Intersect(
        self, ray_p: Vector, ray_dir: Vector, length: Any, only_test: bool
    ) -> bool:
        """
...
class SplineHelp(object):
    ...
    def InitSpline(
        ...
        op: BaseObject,
        up: Optional[Vector] = ...,
        rail: Optional[BaseObject] = ...,
        target_rail: Optional[bool] = ...,
        use_deformed_points: Optional[bool] = ...,
        force_update: Optional[bool] = ...,
        use_global_space: Optional[bool] = ...,
    ) -> bool:
        """
    ...
    def InitSplineWith(self, op: BaseObject, flags: int) -> bool:
        ...
        """
        ...
    def InitSplineWithUpVector(
        self, op: BaseObject, upvector: Vector, flags: int
    ) -> bool:
        """
        ...
        """
        ...
    def InitSplineWithRail(
        self, op: BaseObject, rail: BaseObject, flags: int
    ) -> bool:
        """
    ...
    def GetPointIndex(self, offset: float, segment: int) -> int:
        ...
        ...
    def GetPos(
        self, offset: float, segment: int, smooth: bool, realoffset: bool
    ) -> Vector:
        """
        .. deprecated:: R15
...
class ViewportSelect(object):
    ...
    def GetNearestEdge(
        ...
        ...
    def DrawPolygon(
        self, p: Any, i: int, op: BaseObject, onlyvisible: int
    ) -> bool:
        """
        ...
        ...
    def DrawHandle(
        self, p: Vector, i: int, op: BaseObject, onlyvisible: int
    ) -> bool:
        """
...
def CalculateVisiblePoints(
    bd: BaseDraw, op: PolygonObject, visible: Optional[bool] = ...
) -> List[int]:
    """
...
def QSquad(
    q0: Quaternion, q1: Quaternion, q2: Quaternion, q3: Quaternion, alfa: float
) -> Quaternion:
    """
...
def QSmoothCubic(
    qn_m1: Quaternion, qn: Quaternion, qn_p1: Quaternion, t: float
) -> Quaternion:
    """
...
def GetOptimalAngle(
    hpb_old: Vector, hpb_new: Vector, rotation_order: int
) -> Vector:
    """
...
def CalcSplineMovement(
    newPos: Vector,
    offset: float,
    type: int,
    splineMg: Matrix,
    bd: Optional[BaseDraw] = ...,
    planeNormal: Optional[Vector] = ...,
    closed: Optional[bool] = ...,
    lockTangentAngle: Optional[bool] = ...,
    lockTangentLength: Optional[bool] = ...,
    breakTangents: Optional[int] = ...,
    pcnt: Optional[int] = ...,
    padr: Optional[Any] = ...,
    tadr: Optional[List[Dict[str, Any]]] = ...,
) -> None:
    """
...
def CalcSplineDefaultTangents(
    type: int, closed: bool, pcnt: int, padr: Any
) -> List[Dict[str, Any]]:
    """
...
def BooleanSplines(
    initialSpline: BaseObject,
    booleanObjects: List[SplineObject],
    doc: BaseDocument,
    bd: BaseDraw,
    projectionAxis: int,
    booleanMode: int,
...
def CalculateTranslationScale(
    src: Union[BaseDocument, UnitScaleData],
    dst: Union[BaseDocument, UnitScaleData],
) -> float:
    """
...
def PointLineSegmentDistance(
    segmentPoint1: Vector, segmentPoint2: Vector, pos: Vector
) -> None:
    """
...
def PointLineSegmentDistance2D(
    segmentPoint1: Vector, segmentPoint2: Vector, pos: Vector
) -> None:
    """
